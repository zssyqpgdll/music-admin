...
.sn-container {
  ...
  .person{
    ...
    .pers{
      ...
      &.person1{
        background-image: url(../../../assets/daping/img/online.png);
        transform: rotateX(64deg) rotateZ(0deg);
        top: 16%;
      }
      &.person2{
        background-image: url(../../../assets/daping/img/cir-2.png);
      ...
      &.person3{
        background-image: url(../../../assets/daping/img/person-1.png);
        top: 5%;
      }
    }
  }
  ...
  .text{
    ...
    width: 50px;
    height: 50px;
    background-image: url(../../../assets/daping/img/cir-1.png);
    background-repeat: no-repeat;
    background-position: center center;
