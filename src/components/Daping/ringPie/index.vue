...
.sn-container {
  ...
  .back-chart{
    ...
    left: 0;
    top: 0;
    background:url(../../../assets/daping/img/back_chart.png) no-repeat center;
  }
  .arrow-cir {
    width: 8px;
    height: 8px;
    ...
    opacity: 0;
    &.arrow-cir1 {
      background: url(../../../assets/daping/img/icon_04.png) no-repeat 50% 50%;
    ...
    &.arrow-cir2 {
      background: url(../../../assets/daping/img/icon_05.png) no-repeat 50% 50%;
