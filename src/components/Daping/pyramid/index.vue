...
.trigle {
  ...
  .back_img {
    ...
    width: 100%;
    height: 300px;
    background: url(../../../assets/daping/img/chart2/icon_db02.png) no-repeat center;
  ...
  .back_img1 {
    ...
    width: 100%;
    height: 100%;
    background: url(../../../assets/daping/img/chart2/icon_db03.png) no-repeat center;
  ...
  .back_img2 {
    ...
    width: 100%;
    height: 300px;
    background: url(../../../assets/daping/img/chart2/icon_db04.png) no-repeat center;
  ...
  .back_img3 {
    ...
    width: 100%;
    height: 300px;
    background: url(../../../assets/daping/img/chart2/icon_db01.png) no-repeat center;
  ...
  .detail {
    ...
    .detail_txt {
      ...
      .txt_right {
        ...
        .f_div {
          ...
          &.aharrow_down {
            &:before {
              @extend %arrow_icon;
              background: url(../../../assets/daping/img/chart2/icon_jt01.png) no-repeat center;
            }
          }
          &.aharrow_up {
            &:before {
              @extend %arrow_icon;
              background: url(../../../assets/daping/img/chart2/icon_jt02.png) no-repeat center;
            }
          }
        }
        .s_div {
      ...
      .precent_txt {
        ...
        margin: 5px;
        &.precent_txt1 {
          background: url(../../../assets/daping/img/chart2/icon_xfq04.png) no-repeat center;
        }
        &.precent_txt2 {
          background: url(../../../assets/daping/img/chart2/icon_xfq03.png) no-repeat center;
        }
        &.precent_txt3 {
          background: url(../../../assets/daping/img/chart2/icon_xfq01.png) no-repeat center;
        }
        &.precent_txt4 {
          background: url(../../../assets/daping/img/chart2/icon_xfq02.png) no-repeat center;
        }
      }
    }
  }
