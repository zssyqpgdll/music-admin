...
.sn-container {
  ...
  .pd-main-left {
    ...
    .yun-container {
      ...
      background: url(../../../assets/daping/img/pd-main-left-bg-2.png) no-repeat 50% 50%;
      .yun-tree {
        width: 100%;
        height: 100%;
        background: url(../../../assets/daping/img/pd-main-left-bg-tree.png) no-repeat 50% bottom;
        mix-blend-mode: screen;
      }
      .line-fs {
        width: 14px;
        height: 100%;
        background-image: url(../../../assets/daping/img/line-fs.png);
