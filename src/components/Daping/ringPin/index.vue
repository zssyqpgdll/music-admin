...
.sn-container {
  ...
  .definfo {
    ...
    &.definfo0 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_ls.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 62px;
    ...
    &.definfo1 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_hs.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 100px;
    ...
    &.definfo2 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_cs.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 112px;
    ...
    &.definfo3 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_zs.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 66px;
    ...
    &.definfo4 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_ml.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 99px;
    ...
    &.definfo5 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_sl.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 118px;
    ...
    &.definfo6 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_ql.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 141px;
    ...
    &.definfo7 {
      ...
      span {
        &:nth-child(1) {
          background: url(../../../assets/daping/img/icon_qql.png) repeat 0 0 !important;
        }
        &:nth-child(2) {
          height: 117px;
