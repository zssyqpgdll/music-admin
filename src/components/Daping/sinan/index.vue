  ...
  .pd-main {
    ...
    .compass {
      ...
      .compass-bg-c-1 {
        width: 100%;
        height: 100%;
        background: url(../../../assets/daping/img/chart1/compass-bg-1.png) no-repeat 50% 345px;
      }
      .compass-bg-c-2 {
        width: 100%;
        height: 100%;
        background: url(../../../assets/daping/img/chart1/compass-bg-2.png) no-repeat 65% 146px;
        opacity: 0.8;
      ...
      .compass-bg-c-3 {
        width: 100%;
        height: 100%;
        background: url(../../../assets/daping/img/chart1/compass-bg-3.png) no-repeat 50% 227px;
      }
      .compass-bg-c-4 {
        width: 100%;
        height: 100%;
        background: url(../../../assets/daping/img/chart1/compass-bg-4.png) no-repeat 50% 63px;
      ...
      .line-sx {
        ...
        .line-fs {
          width: 14px;
          height: 100%;
          background: url(../../../assets/daping/img/chart1/line-fs.png) no-repeat;
