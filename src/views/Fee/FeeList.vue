<template>
  <div>
    ...
    <div class="header-menu">
      ...
      <el-input placeholder="搜索会员名" v-model="keyword.keyword" @clear="inputListener" clearable>
...
<!--      <el-button type="primary" @click="addStudent()" class="addbtn">添加</el-button>-->
    ...
    <el-table :data="studentData" size="mini" :stripe="true" :highlight-current-row="true">
      ...
      <el-table-column prop="reason" label="费用" ></el-table-column>
...
<script>
  import {add,get,search,modify} from "@/api/fee";
