<template>
  <div>
    ...
    <div class="header-menu">
      <el-input placeholder="搜索纠错" v-model="keyword" @clear="inputListener" clearable>
...
<!--      <el-table-column prop="title" label="标题"></el-table-column>-->
      ...
      <el-table-column prop="author" label="纠错人" ></el-table-column>
...
<script>
  import {add,del,modify,get,search} from "@/api/mistake";
