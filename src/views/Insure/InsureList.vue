<template>
  <div>
    ...
    <div class="header-menu">
      ...
      <el-input placeholder="搜索保险申请" v-model="keyword.keyword" @clear="inputListener" clearable>
...
<!--      <el-table-column prop="studentNo" label="学号" fixed width="100"></el-table-column>-->
      <el-table-column prop="groupId" label="工会" :formatter="groupNameFilter"></el-table-column>
      <el-table-column prop="realname" label="会员" ></el-table-column>
      ...
      <el-table-column prop="type" label="类型" :formatter="typeFilter"></el-table-column>
...
<script>
  import {add,del,modify,get,search} from "@/api/insure";
