<template>
  <el-row ref="tc" :gutter="40">
    <el-col  :xs="6" :sm="6" :lg="6">
      <tagsCloud :useArray="useArray" :boxWidth="300" :speed="3000" :randomColor="true"></tagsCloud>
    </el-col>
    <el-col  :xs="6" :sm="6" :lg="6">
      <tagsCloud :useArray="useArray" :boxWidth="300" :speed="3000" :randomColor="true"></tagsCloud>
    </el-col>
...
<script>
  ...
  export default {
    ...
    mounted(){
      //const height = this.$refs.tc.offsetHeight
      //this.boxWidth = height
      console.log(this.$refs.tc.offsetHeight)
