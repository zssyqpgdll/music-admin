...
import {pieChart, raddarChart} from "@/api/chart";
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      // raddarChart().then(res=>{
      //   console.log(res.data.raddarData)
      //   this.initChart(res.data.raddarData)
      // })
      this.initChart()
    })
  },
    ...
    initChart(data) {
      ...
      const option = {
        ...
        series: [{
          ...
          zlevel: -1,
          data: [
            new Date("2020-05-01"),  //这个是任务的固定开始时间
            new Date("2020-03-14"),
            new Date("2020-05-07")]
        },
          {
