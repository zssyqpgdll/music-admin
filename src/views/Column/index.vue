...
<!--    <el-button type="primary" @click="handleAddRole">New Role</el-button>-->
    ...
    <el-table :data="columns" style="width: 100%;margin-top:30px;" border>
      <el-table-column align="center" label="序号" width="80">
        <template slot-scope="scope">
          {{ scope.row.id }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="栏目名" width="250">
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      </el-table-column>
      <el-table-column align="header-center" label="栏目英文名" width="380">
        <template slot-scope="scope">
          {{ scope.row.engTitle }}
        </template>
      </el-table-column>
...
<!--      </el-table-column>-->
    ...
    <el-dialog title="编辑栏目" :visible.sync="visibleForm">
      <el-form
          :model="editFormData"
          label-position="left"
          label-width="80px"
      >
        ...
        <el-form-item label="栏目英文名" prop="engTitle">
          <el-input v-model="editFormData.engTitle" autocomplete="off"></el-input>
        </el-form-item>
...
<script>
import {get, update} from "@/api/column";
