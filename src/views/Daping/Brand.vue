...
<script>
import '@/assets/daping/js/flexible'
import '@/assets/daping/js/china'
import countTo from 'vue-count-to'
import {getTianqi} from "@/api/dash";
  ...
  methods: {
    ...
    getWeather() { // 第三方天气api接口
      getTianqi().then(res => {
        if (res) {
          if (res.wea_img == 'xue') {
            this.imgSrc = require('../../assets/daping/img/brand/xue.png');
          } else if (res.wea_img == 'yin') {
            this.imgSrc = require('../../assets/daping/img/brand/yin.png');
          } else if (res.wea_img == 'yu' || res.data.wea_img == 'bingbao') {
            this.imgSrc = require('../../assets/daping/img/brand/yu.png');
          } else if (res.wea_img == 'yun') {
            this.imgSrc = require('../../assets/daping/img/brand/yun.png');
          } else if (res.wea_img == 'wu') {
            this.imgSrc = require('../../assets/daping/img/brand/wu.png');
          } else if (res.wea_img == 'shachen') {
            this.imgSrc = require('../../assets/daping/img/brand/shachen.png');
          } else if (res.wea_img == 'lei') {
            this.imgSrc = require('../../assets/daping/img/brand/lei.png');
          } else {
            this.imgSrc = require('../../assets/daping/img/brand/qing.png');
          }
...
.brand-container {
  ...
  background: #000;
  .wrap {
    background: url(../../assets/daping/img/brand/bg.jpg) no-repeat #000;
    background-size: cover;
    line-height: 1.15;
    header {
      position: relative;
      height: 1rem;
      background: url(../../assets/daping/img/brand/head_bg.png) no-repeat top center;
    ...
    .mainbox {
      ...
      .item {
        ...
        %map-style {
          ...
          width: 6.475rem;
          height: 6.475rem;
          background: url(../../assets/daping/img/brand/map.png) no-repeat;
          background-size: 100% 100%;
          opacity: 0.3;
        }
        .map {
          ...
          .map2 {
            ...
            width: 8.0375rem;
            height: 8.0375rem;
            background-image: url(../../assets/daping/img/brand/lbx.png);
            opacity: 0.6;
          ...
          .map3 {
            ...
            width: 7.075rem;
            height: 7.075rem;
            background-image: url(../../assets/daping/img/brand/jt.png);
        ...
        .panel {
          ...
          height: 3.875rem;
          border: 1px solid rgba(25, 186, 139, 0.17);
          background: rgba(255, 255, 255, 0.04) url(../../assets/daping/img/brand/line.png);
